...
<head>
    ...
    <style>
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #111; color: #0f0; margin:0; padding:0; }
...
.floor-wrap { display: flex; flex-direction: column; align-items: center; }
        ...
        .floors::-webkit-scrollbar-thumb { background: #444; border-radius: 6px; }
